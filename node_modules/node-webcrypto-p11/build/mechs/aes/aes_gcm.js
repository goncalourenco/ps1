...
class AesGcmProvider extends core.AesGcmProvider {
    ...
    onEncrypt(algorithm, key, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return crypto_1.AesCrypto.encrypt(this.crypto.session, false, algorithm, key, new Uint8Array(data));
        });
    }
    onDecrypt(algorithm, key, data) {
        return tslib_1.__awaiter(this, void 0, void 0, function* () {
            return crypto_1.AesCrypto.decrypt(this.crypto.session, false, algorithm, key, new Uint8Array(data));
        });
    }
